        ...
        if not AutoAdminMiddleware._admin_created:
            ...
            try:
                ...
                if not admin_user.is_staff:
                    ...
                    updated = True
                if created or not admin_user.check_password('Omnexadnn@2704'):
                    admin_user.set_password('Omnexadnn@2704')
                    updated = True
                
                if updated:
                    admin_user.save()
                    print("AutoAdminMiddleware: Superuser 'admin' created/updated successfully with password 'Omnexadnn@2704'")
